...
def get_plots(tab, age, ed_level, employ_status, dev_status, years_code):
    ...
    if tab == 'tech-used':
        ...
        df = df[(df['Age'].isin(age)) & 
                (df['EdLevel'].isin(ed_level)) & 
                (df['Employment'].isin(employ_status)) & 
                (df['MainBranch'].isin(dev_status))]

        # Filter by the number of years coding
        df = df[(df['YearsCode'] >= years_code[0]) & (df['YearsCode'] <= years_code[1])]
        
        ## Languages Used
        ## LanguageHaveWorkedWith
        lang_worked = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'LanguageHaveWorkedWith']].copy()
        ...
        db_worked = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'DatabaseHaveWorkedWith']].dropna().copy()
        ...
        web_worked = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'WebframeHaveWorkedWith']].dropna().copy()
        ...
        collab_worked = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'NEWCollabToolsHaveWorkedWith']].dropna().copy()
    ...
    ## Technologies Desired
        ...
        lang_want = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'LanguageWantToWorkWith']].dropna().copy()
        ...
        db_want = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'DatabaseWantToWorkWith']].dropna().copy()
        ...
        web_want = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'WebframeWantToWorkWith']].dropna().copy()
        ...
        collab_want = df[['Age', 'EdLevel', 'Employment', 'MainBranch', 'YearsCode', 'NEWCollabToolsWantToWorkWith']].dropna().copy()
    ...
    # Demographics
        ...
        ed_level_counts = df['EdLevel'].value_counts().reset_index()
        ...
        dev_status_counts = df['MainBranch'].value_counts().reset_index()
        ...
        employ_counts = df['Employment'].value_counts().reset_index()
